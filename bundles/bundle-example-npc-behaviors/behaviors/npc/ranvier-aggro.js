      ...
      if (this._aggroTarget) {
        ...
        if (sinceLastCheck >= delayLength) {
          if (!this._aggroTarget.isNpc) {
            ...
            Logger.verbose(`NPC [${this.uuid}/${this.entityReference}] ${this.uuid} attacks NPC [${this._aggroTarget.uuid}/${this._aggroTarget.entityReference}] in room ${this.room.entityReference}.`);
          }
