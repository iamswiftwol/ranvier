...
module.exports = {
  event: state => (socket, args) => {
    ...
    */
    ...
    const canAddCharacter = false;//characters.length < maxCharacters;
    ...
    options.push({
      ...
      onSelect: () => {
        say('<bold>By deleting this account, you will no longer be able to use your Telegram account on this server.</bold>');
